...
def measurement_update(sensor_var, p_cov_check, y_k, p_check, v_check, q_check):
    ...
    err_x=k_k.dot(y_k-p_check)
    # 3.3 Correct predicted state
    p_hat=p_check+err_x[0:3]
    v_hat=v_check+err_x[3:6]
    q_hat=  Quaternion(euler=err_x[6:]).quat_mult_right(q_check)
