...
class Controller2D(object):
    ...
    def update_controls(self):
        ...
        if self._start_control_loop:
            ...
            k= 0.3
            a = (waypoints[-1][1]-waypoints[0][1])/( waypoints[-1][0]-waypoints[0][0])
            b = -1.0
            c = waypoints[0][1]-a*waypoints[0][0]

            # heading error
            yaw_path=np.arctan2(waypoints[-1][1]-waypoints[0][1], waypoints[-1][0]-waypoints[0][0])
            err1 = np.arctan2(waypoints[-1][1]-waypoints[0][1], waypoints[-1][0]-waypoints[0][0])-yaw
