    ...
    def collision_check(self, paths, obstacles):
        ...
        for i in range(len(paths)):
            ...
            for j in range(len(path[0])):
                ...
                # --------------------------------------------------------------
                for k in range(len(self.circle_offsets)):
                    circle_locations[k, 0] = path[0][j] + self.circle_offsets[k]*cos(path[2][j])
                    circle_locations[k, 1] = path[1][j] + self.circle_offsets[k]*sin(path[2][j])
                # --------------------------------------------------------------
